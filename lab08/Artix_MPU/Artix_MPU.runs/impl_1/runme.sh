...
HD_PWD='C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab08/Artix_MPU/Artix_MPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Artix_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Artix_wrapper.tcl -notrace
