...
HD_PWD='C:/Users/janro/Pulpit/AGH_FILES/SR-2024S/lab08/Artix_MPU/Artix_MPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Artix_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Artix_wrapper.tcl
